...
checkinstall -D -y \
	...
	--requires="kquickimageeditor,libc6,libexiv2-27,libqt5core5a,libqt5positioning5,libqt5positioning5-plugins,libqt5positioningquick5,libqt5qml5,libqt5sql5,libstdc++6,mauikit-git \(\>= 2.2.1+git\),qml-module-org-kde-kirigami2" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
